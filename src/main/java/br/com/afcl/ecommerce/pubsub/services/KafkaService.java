...
import br.com.afcl.ecommerce.pubsub.deserializer.GsonDeserializer;
...
public final class KafkaService<T> implements Closeable {
    ...
    public KafkaService(Constants topic, ConsumerFunction<T> parse, Class<T> clazzType, String groupID,
        ...
        this.kafkaConsumer.subscribe(Pattern.compile(this.topic.getName()));
    }
